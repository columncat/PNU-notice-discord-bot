...
NOTICE_URL = "https://me.pusan.ac.kr/new/sub05/sub01_02.php"
...
def __get_title(num):
    url = f'https://me.pusan.ac.kr/new/sub05/sub01_02.php?seq={str(num)}&db=gradnotice&page=1&perPage=20&SearchPart=BD_SUBJECT&SearchStr=&page_mode=view'
...
def update():
    ...
    if (updates.__len__() > 0):
        ...
        for update in updates:
            ...
            url = f'https://me.pusan.ac.kr/new/sub05/sub01_02.php?seq={update.__str__()}&db=gradnotice&page=1&perPage=20&SearchPart=BD_SUBJECT&SearchStr=&page_mode=view'
