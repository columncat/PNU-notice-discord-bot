import requests
import os.path
from app_private import mec_graduate_channel
from bs4 import BeautifulSoup


INDEX_FILE = "mec_graduate.txt"
NOTICE_URL = "https://me.pusan.ac.kr/new/sub05/sub01_02.asp"
CHANNEL_ID = mec_graduate_channel
...
def __get_title(num):
    url = f'https://me.pusan.ac.kr/new/sub05/sub01_02.asp?seq={num.__str__()}&db=gradnotice&page=1&perPage=20&SearchPart=BD_SUBJECT&SearchStr=&page_mode=view'
...
def update():
    ...
    if (updates.__len__() > 0):
        ...
        for update in updates:
            ...
            url = f'https://me.pusan.ac.kr/new/sub05/sub01_02.asp?seq={update.__str__()}&db=gradnotice&page=1&perPage=20&SearchPart=BD_SUBJECT&SearchStr=&page_mode=view'
